...
export const CoralButton = styled(Button)`
  && {
    background-color: #FF7F50; /* Coral */
    color: white;
    margin-left: 4px;
    &:hover {
      background-color: #FF6F61; /* Slightly darker coral */
      box-shadow: none;
    }
  }
`;

export const DarkCoralButton = styled(Button)`
  && {
    background-color: #FF4040; /* Dark coral */
    color: white;
    &:hover {
      background-color: #FF3333; /* Even darker coral */
      box-shadow: none;
    }
  }
`;

export const LightCoralButton = styled(Button)`
  && {
